...
export const replies = {
  ...
  mood: [
    ...
    "Чувствую себя как свежий френч — идеально!",
    "Как всегда — в тон клиенткам 😉"
  ],
  bye: [
  ...
  reaction: [
    "Ну вот 😌",
    "Понимаю.",
    "Может, посмотрим другие варианты?"
  ]
};
...
export function matchService(text) {
  ...
  for (const key in services) {
    if (norm === key || norm.includes(key)) {
      return { name: key, exact: norm === key };
    }
    if (norm.includes("хочу") && norm.includes(key.split(" ")[0])) {
